...
class MatchIdSeeder(Bootstrap):
    ...
    async def run(self):
        ...
        r = requests.get("https://canisback.com/matchId/matchlist_{}.json".format(server))
        
        if r.status_code == 404:
            raise Exception("This server is not supported for seeding matchIds, please try another seeding method.")
